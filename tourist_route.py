...
for i in range(n): matrix.append(
    list(map(float, input(f"Введіть відстані від {i + 1}-ого місця до усіх інших місць:\n").split())))

for i in range(n): matrix1.append(matrix[i].copy())
